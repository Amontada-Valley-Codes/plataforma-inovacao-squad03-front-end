      ...
      {links.map((item, index) => {
        ...
        return (
          <button
            ...
            className="flex items-center gap-2 bg-white text-[#003f5c] border border-[#c9c9c9] uppercase text-[13px] px-4 py-2 rounded-2xl font-medium tracking-wide hover:bg-[#5bc30d]/30 transition-all whitespace-nowrap"
          >
